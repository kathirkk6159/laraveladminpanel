...
<div class="site-branding-area">
	...
	<h4 class="product_header">{{$machinesdata->title}}</h4>
  <div class="image-gallery">
    <main class="primary1 mainimage{{$machinesdata->id}}" style="background-image: url({{url('storage/'.$machinesdata->image)}});"></main>
...
@endforeach
	...
	<div class="maincontent-area">				   
			...
			<img src="{{url('storage/'.$recentmachinesdata->image)}}"  alt="{{$recentmachinesdata->title}}">													</div>													
			<h2>Meuser Small Lathe</h2>													
			<div class="product-carousel-price">my machine</div>													
			<div class="pro_more_detail">													   
			<a href="{{$recentmachinesdata->title}}"><button type="button" class="submit" href="#">click description</button>	</a>												</div>												
			</div>											
			</div>		             @endforeach
			</div>
		...
		<div class="col-md-12">
		<h4 class="product_header  recent_pro_header">{{$pagesrequest->title}}</h4>
		<div class="wht_we_do">{!! $pagesrequest->content !!}
	</div>
	</div>
		</div>
	<div class="col-md-12">
